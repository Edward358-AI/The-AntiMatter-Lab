...
useHead({
    ...
    meta: [
        { name: 'description', content: 'Explore the concept of equilibrium in physics, particularly its types and real-world scenarios.' }
    ]
})
...
const page = storeToRefs(useUserStore()).EqTypes
...
<template>
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <div v-show="page===0" ><h4 class="text-center">Introduction</h4>
            ...
            <span v-show="level > 0">
                <span v-show="level == 1">
                    We first need to introduce a new few new ideas. First off, the negative slope of a graph of
                    potential
                    ...
                    A critical point is when the slope of a function is zero, usually at a local maximum or minimum.
                    These
                ...
                <span v-show="level == 2">
                    ...
                    $$ F = -\frac{dU}{dx} $$
                    <br>
                    As a reminder, this means that the force acting on a system is equal to the negative of the
                    derivative of the potential energy with respect to position.
                    This means that equilibrium points are where this derivative is equal to zero, or where the slope of
                    the potential energy graph is zero.
                    <br><br>
                </span>
                ...
                <br><br>
                <figure>
                    <img src="/energy/Figure 55.png" style="max-width:750px" />
                    <figcaption>
                ...
                <span v-show="level == 2">
                    This concept is pretty heavily dependent on calculus, as you might have already noticed. For the
                    sake of continuity and simplicity, I won't
                    purely explain it in calculus terms, though you calculus students will have some explanation
                    tailored to you.
                </span>
            </span>
            <span v-show="level == 0">
                This lesson is actually really dependent on calculus, though interestingly enough it has a lot of
                content at a conceptual level that doesn't require calculus. You just need to know how to analyze
                graphs.
                <br><br>
                The first thing you should know is that the negative slope of the potential energy versus position graph
                is equal to the force acting on the system at that point.
                This is a result that comes from a calculus definition of force, work, and energy, so we won't get into
                it here. The next thing you should
                know is a local maximum or minimum is a point where the function is the highest or lowest in a small
                region around it. These can also be called
                ...
                We will get into all of these conceptually in this lesson, without any calculus explanations. It is
                sufficient to use
                qualitative analysis, since these really depend on analyzing the shape of the potential energy graph,
                which is no Herculean task.
            </span>
        ...
        <div v-show="page === 1">
            ...
            <span v-show="level > 0">
                The <b>stable equilibrium</b> is characterized by a local minimum in the potential energy graph. If we
                look at
                the graph, we can see that if we displace the system from this point, it will return to the equilibrium
                point.
                As an analogy, we can think of the potential energy graph as a graph of height versus position, since
                gravitational
                potential energy depends directly on height.
                <br><br>
                <figure>
                    <img src="/energy/Figure 56.png" />
                    <figcaption>
                        Figure 2: A typical stable equilibrium. The ball is at the bottom of a bowl and will roll back
                        down to the bottom if displaced.
                    </figcaption>
                </figure>
                <br>
                You can think of the ball in the bowl as a good general example, but we aren't always going to deal with
                gravitational potential energy. The concept is more
                general than that. There are instances like this in many different systems, such as springs, pendulums,
                and even more complex systems involving electricity and magnetism.
                However, some things remain the same for all stable equilibriums regardless of specific circumstances.
                <br><br>
                If we displace a system that is at stable equilibrium slightly from the equilibrium point, it will roll
                back down to the equilibrium point, like a ball in a bowl.
                The forces acting on the ball near this point are <b>restoring forces</b> that will tend to return the
                system to the equilibrium point. This term will
                come up again later, so remember it.
                <br><br>
                <span v-show="level == 2">

                    In terms of the second derivative of the graph, it is where the concavity of the graph is positive,
                    or where the second derivative is positive.
                    The slope of the graph is increasing in this region, but this isn't really important to our
                    analysis.
                    <br><br>
                ...
                In general, stable equilibrium is characterized by a local minimum in the potential energy graph. This
                makes sense, since a system
                will generally tend to return to a state of lower potential energy, which makes the equilibrium point
                stable. The system also
                experiences a restoring force that is oppositely directed to the displacement from the equilibrium
                point, which should
                sound similar to the springs we investigated earlier.
            </span>
            <span v-show="level == 0">
                A <b>stable equilibrium </b>is where the object will tend to return to equilibrium if it is slightly
                disturbed. This can
                be thought of as a ball at the bottom of a bowl. If you displace the ball slightly, it will roll back
                ...
                <br>
                Like the ball in the bowl, if we displace a system that is at stable equilibrium slightly from the
                equilibrium point, it will roll back down to the equilibrium point.
                This indicates that the force acting on the object is in the opposite direction of the displacement from
                the equilibrium. These kinds of forces are called
                <b>restoring forces</b>, since they tend to restore the system to the equilibrium point. This term will
                come up again later, so remember it.
                <br><br>
                A stable equilibrium is a point that has the lowest potential energy in a small region around it. This
                explains why the system will tend to return to this point, since
                objects and systems tend to go towards points of lower potential energy. In math terms, this is a local
                minimum in the potential energy versus position graph.
            </span>
        ...
        <div v-show="page === 2">
            ...
            <span v-show="level > 0">
                The <b>unstable equilibrium</b> is, well, unstable. It's characterized by a local maximum rather than
                minimum in the potential energy graph. Even though
                the shapes of the graphs are similar, the unstable equilibrium is literally the antithesis of the stable
                equilibrium. If we displace the system from this point,
                it will not return to the equilibrium point. Actually, even that's putting it lightly.
                <br><br>
                <figure>
                    <img src="/energy/Figure 57.png" />
                    <figcaption>
                        Figure 3: A typical unstable equilibrium. The ball is at the top of a hill and will roll down
                        the hill if displaced.
                    </figcaption>
                </figure>
                <br>
                The unstable equilibrium is like a ball at the top of a hill. If you displace the ball slightly, it will
                roll down the hill
                away from the equilibrium point. This is because the forces acting on the ball near this point are not
                restoring forces, but rather
                forces that tend to push the system away from the equilibrium point. There isn't a term for this kind of
                force, since it's not
                as interesting as a restoring force.
                <br><br>
                In certain cases, the object's distance from the equilibrium point will increase exponentially. A simple
                case that causes this
                is the anti-Hooke's law (not the official name), which is a force that is directed in the same direction
                as the displacement from equilibrium that follows
                Hooke's Law.
                <br><br>
                $$F = kx$$
                <br>
                See how there's no negative sign? This means that the force is directed in the same direction as the
                displacement from equilibrium, which is why it
                causes the system to move away from the equilibrium point exponentially. This is a pretty specific case,
                but it is very similar to Hooke's Law, which
                we covered earlier. Even a small change in the formula can have a big impact on the system's behavior.
                <br><br>
                <span v-show="level == 2">
                    In terms of the second derivative of the graph, an unstable equilibrium is located where the
                    concavity of the potential energy graph is negative, or where the second derivative is negative.
                ...
                In general, unstable equilibrium is characterized by a local maximum in the potential energy graph. This
                also makes sense according
                to logic we used before. Systems dislike points of high potential energy, tending to move away to a
                point of lower potential energy.
                In the real world, these equilibriums are often short-lived, as the multitude of forces in a real
                environment will inevitably disturb a system
                from this unstable equilibrium and cause it to decay to a more stable state. Think of how hard it is to
                make a card tower. Even breathing on the
                structure too hard can cause it to collapse.
                <br><br>
                We typically interchange equilibrium and stability, but this case shows how different the two can be.
                While at the unstable equilibrium forces are technically balanced, any disturbance will prompt the
                system to move away from the equilibrium point in
                a very unstable manner. The term "unstable equilibrium" is therefore not an oxymoron (at least in
                physics), but rather something that describes everyday scenarios.
            ...
            <span v-show="level == 0">
                ...
                of potential energy. This is called a local maximum in the potential energy graph. We said before that
                systems sort of dislike having potential energy, trying
                to get themselves into the lowest possible potential energy state. This is why the ball will roll away
                from the
                equilibrium at the top of the mountain if disturbed: it will seek a position of lower potential energy
                elsewhere.
                <br><br>
                This is why this kind of equilibrium is <b>unstable</b>: because the object or system doesn't like to
                stay at such a point.
                Most unstable equilibria decay rapidly, since any small external disturbance can cause the fragile state
                of equilibrium to
                collapse. Note that equilibrium and stability are not the same thing in physics, even though we
                sometimes interchange them.
            ...
            <figure>
                ...
                <div id="unstable"></div>
                <button class="btn btn-outline-primary" @click="runUnstableEq()">Reset</button><br>
            ...
            will be able to stand on its tip for a short time because the initial conditions are perfect, but eventually
            even slight calculational approximations done by
            Matter.js will cause it to slip over and fall. I'll venture to say that it's virtually impossible to stand
            the pencil back up once it has fallen. Prove me wrong!
            <div class="btn-contain-left">
                <button class="btn btn-dark" style="animation: scale1 2s infinite;" @click="page--">&larr;
                    Previous</button>
            </div>
        ...
        <div v-show="page === 3">
            <br>
            <figure>
                <h4>Neutral Equilibrium</h4>
            </figure>
            <span v-show="level > 0">
                This is kind of a weird one. You might think that stable and unstable cover all the types of
                equilibriums since
                they're opposites of each other, but there is a third, more dull kind of equilibrium. This case pretty
                much covers
                all equilibria that are not stable or unstable. <span v-show="level == 2">Technically, this is an
                    inflection
                    point ($\frac{d^2U}{dx^2}=0$) where concavity changes, but I've found that this definition is a bit
                    misleading.
                </span>
                In a <b>neutral equilibrium</b>, the system will remain in its new position if disturbed. Let me explain
                what I mean.
                <br><br>
                <figure>
                    <img src="/energy/Figure 58.png" />
                    <figcaption>
                        Figure 4: A typical neutral equilibrium. The ball will still be in equilibrium if displaced.
                    </figcaption>
                </figure>
                <br>
                The system will move to a new equilibrium if displaced slightly. It might go back to being at rest, or
                it could continue on at constant
                velocity if there are no dissipative forces. For the case of the ball on the table, small displacements
                will cause it to move around on
                the table. But, the ball will be at equilibrium at any point on the table, so it will neither accelerate
                away from nor return to
                its original position. See what I meant when I said this covers any cases that unstable and stable
                equilibrium do not?
                <br><br>
                This kind of equilibrium is characterized by a flat section in the potential energy versus position
                graph. In the flat section,
                potential energy doesn't change with position, displacing the object will still result in zero net force
                being exerted on it.
                Additionally, there is no tendency for the object to move, as all points around it are at the same
                potential energy.
                <br><br>
                <span v-show="level == 2">While this can be defined as an inflection point, at inflection points
                    the concavity is simply changing, which does not automatically produce a neutral equilibrium. Think
                    of the arbitrarily defined function
                    $U(x) = x^3$, which has an inflection point at $x=0$. If we displace an object at this point to the
                    right, it will eventually end up
                    sliding to the left to negative infinity; the same applies if we displace it to the left. This is
                    not really a neutral equilibrium then!
                    <br><br>
                    Moreover, we typically don't think of flat sections as inflection points, but this is what
                    a neutral equilibrium is typically characterized by. Therefore, do not rely on the calculus
                    definition too closely and
                    opt for analyzing the scenario instead.
                    <br><br>
                </span>
                While this kind of equilibrium is quite common (think of books on a table, boxes placed on the ground,
                etc.), it is
                not interesting in the slightest. After all, nothing happens (more precisely, $a=0$) after you displace
                the object, so
                the scenario is easy to analyze. It is much more interesting to analyze whether systems are in stable or
                unstable equilibrium.

            </span>
            <span v-show="level == 0">
                The <b>neutral equilibrium</b> is <b>NOT</b> a middle point between stable and unstable equilibriums,
                but something
                quite different. We can think of it as a ball sitting on a table. If we move it slightly, it will
                neither roll away from nor
                ...
                <br>
                The ball will have the same potential energy at all points close to it, which means that it has no
                tendency to move or to return.
                To it, all the position you could displace it to are the same (in terms of energy). This kind of
                ...
                <br><br>
                If a stable equilibrium is a ball wishing to stay and unstable is a ball wishing to leave, then a
                neutral equilibrium is a
                ball that is completely indifferent to its predicament. This kind of equilibrium is characterized by
                flat, horizontal sections in the
        ...
        <div v-show="page === 4">
                ...
                <div class="problem">
                    ...
                    <span>
                        ...
                        <div v-show="show" class='answer' style="width:fit-content">
                            <strong>Answer:</strong> This is a neutral equilibrium, since the spacecraft's potential
                            energy will not change if it is displaced due to it
                            being very far from any celestial bodies. In other words, it's not really affected by
                    ...
                    <span>
                        ...
                        <div v-show="show1" class='answer' style="width:fit-content">
                            <strong>Answer:</strong> This is an unstable equilibrium. The coin will easily fall over if
                            disturbed, tending to "leave" this equilibrium.
                            <br>
                        </div>
                    ...
                    <span>
                        <div v-show="show2" class='answer' style="width:fit-content">
                            <strong>Answer:</strong> This is a stable equilibrium. If you slightly push down on the edge
                            of the bowl, it will start rocking back and forth. This indicates
                            that the bowl is attempting to return to equilibrium, as it would move in only one direction
                            if it was leaving the equilibrium. It may even settle back down to its original state
                    ...
                    <span>
                        <div v-show="show3" class='answer' style="width:fit-content">
                            <strong>Answer:</strong> This is a neutral equilibrium. A cone on its side can be rolled
                            around
                    ...
                    <span>
                        <div v-show="show4" class='answer' style="width:fit-content">
                            <strong>Answer:</strong> This is a stable equilibrium. The always spring tends to pull the
                            block towards
                            equilibrium, even though it may not actually achieve equilibrium because the energy put into
                            the system by pulling the block can't simply dissapear.
                            <br>
                        </div>
            ...
            <div v-show="level == 2">
                ...
                of the topic, and one that requires calculus to get through. The conceptual questions are shared between
                all difficulties (because it would honestly
            ...
            <span v-show="level == 2">
                ...
                <br>
                Hopefully, you have a good grasp on how to quickly analyze which type of equilibrium a scenario is. Most
                of the time
                mathematical analysis is not necessary, but to actually prove that a scenario is a particular type of
                equilibrium it is necessary to use calculus to show that its potential energy satisfies the necessary
                conditions. This
                leads us to our calculation problem.
                <br><br>
                <div class="problem">
                    Show that a block of mass $m$ attached to a vertical spring of spring constant $k$ hung from a
                    ceiling is in stable equilibrium.
                    <br><br>
                    This might sound easy, but it's actually a little tricky! I'll give a hint. First off, we want to
                    write a general form for the total potential energy
                    in the system. This means that we have to set some point as our zero gravitational potential energy
                    point. Before we do that, however,
                    we should find where this point should be set in order to minimize the amount of calculation we
                    should do.
                    <br><br>
                    Did you get it? There are many approaches, so I'll start with the one that's the easiest
                    to understand. For this we'll want to set the zero gravitational potential energy point at the point
                    where the spring is not stretched. Next, we want
                    to find how far the spring would stretch at equilibrium, a quantity which we'll call $x_0$. This
                    involves a bit of force analysis, but it's just setting the
                    ...
                    <br>
                    To verify that we've found the correct equilibrium, we can use the relation $F = -\frac{dU}{dx}$ on
                    this to see if
                    $x_0$ is really a equilibrium.
                    <br><br>
                    $$ -\frac {dU}{dx} \big |_{x = x_0} = mg - k x_0 = 0$$
                    <br>
                    Now, we need to find out what kind of equilibrium this is. This means converting the potential
                    energy in a more
                    ...
                    <br>
                    This value is always positive since $k$ is a positive constant, indicating that the equilibrium at
                    $x= x_0$ is, in fact,
                    a stable equilibrium.
                    <br><br>
                    <div class='answer' style="width:fit-content">
                        <strong>Solution:</strong> A mass hung from a vertical spring will be in a state of stable
                        equilibrium at $x=x_0$.

                    </div>
                    <br>
                    An alternative approach is to define the total potential energy at $x=x_0$ to be zero, allowing us
                    to essentially
                    convert this into a horizontal spring problem. If you could see this, you could've skipped a lot of
                    the work
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/energy/power">Next
                    Lesson!
                    &rarr;</NuxtLink>
            </div>
        </div>
    ...
    <div v-show="!lessonShowing" class="container h100 pt-5">
        <h1>Types of Equilibrium Problems</h1><br>
