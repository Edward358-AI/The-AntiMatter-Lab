...
useHead({
    title: 'Collisions',
    meta: [
        { name: 'description', content: 'Explore the physics of collisions, including the principles of momentum conservation and impulse.' }
    ]
})
...
const page = storeToRefs(useUserStore()).Collisions
    ...
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <div v-show="page === 0">
            ...
            <span v-show="level > 0">
                ...
                <div class="problem">
                    ...
                    <br><br>
                    <figure>
                        <img src="/momentum/Figure 70.png" style="max-width:750px">
                        <figcaption>
        ...
        <div v-show="page === 1">
            ...
            <span v-show="level > 0">
                ...
                <div class="problem">
                    ...
                    <br><br>
                    <figure>
                        <img src="/momentum/Figure 71.png" style="max-width:750px">
                        <figcaption>
        ...
        <div v-show="page === 2">
            ...
            <span v-show="level > 0">
                ...
                <br><br>
                <figure>
                    <img src="/momentum/Figure 72.png" style="max-width:750px">
                    <figcaption>
        ...
        <div v-show="page == 3">
            ...
            <span v-show="level > 0">
                ...
                <div class="problem">
                    ...
                    <br><br>
                    <figure>
                        <img src="/momentum/Figure 73.png" style="max-width:750px">
                        <figcaption>
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/momentum/explosions">Next
                    Lesson!
                    &rarr;</NuxtLink>
            </div>
        </div>
