...
useHead({
    ...
    meta: [
        { name: 'description', content: 'Explore the principles of rotational kinematics, including angular displacement, velocity, and acceleration.' }
    ]
})
...
const page = storeToRefs(useUserStore()).RotationalKinematics
...
<template>
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <div v-show="page === 0"><h4 class="text-center">Introduction</h4>
            ...
            <br><br>
            <figure>
                <img src="/rotation/Figure 77.png" />
        ...
        <div v-show="page === 2"><h4 class="text-center">Circular Motion Connection</h4>
            ...
            <span v-show="level > 0">
                ...
                <div class="problem">
                    ...
                    <br><br>
                    <figure>
                        <img src="/rotation/Figure 78.png" />
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/rotation/torque">Next
                    Lesson!
                    &rarr;</NuxtLink>
            </div>
        </div>
    ...
    <div v-show="!lessonShowing" class="container h100 pt-5">
        <h1>Rotational Kinematics Problems</h1><br>
