...
useHead({
    ...
    meta: [
        { name: 'description', content: 'Explore the concept of moment of inertia, its mathematical formulation, and its significance in rotational motion.' }
    ]
})
...
const page = storeToRefs(useUserStore()).MomentInertia
...
<template>
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <div v-show="page === 0"><h4 class="text-center">Introduction</h4>
            ...
            <span v-show="level > 0">
                ...
                <div class="problem">
                    ...
                    <br><br>
                    <figure>
                        <img src="/rotation/Figure 83.png" />
        ...
        <div v-show="page === 2">
            ...
            <br><br>
            <figure>
                <img src="/rotation/Figure 84.png" style="max-width:750px" />
        ...
        <div v-show="page === 3">
            ...
            <span v-show="level > 0">
                ...
                <br>
                <figure>
                    <img src='/rotation/Figure 85.png' />
            ...
            <span v-show="level > 0">
                ...
                <br>
                <figure>
                    <img src="/rotation/Figure 86.png" />
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/rotation/rotational-dynamics">Next
                    Lesson!
                    &rarr;</NuxtLink>
            </div>
        </div>
    ...
    <div v-show="!lessonShowing" class="container h100 pt-5">
        <h1>Moment of Inertia Problems</h1><br>
