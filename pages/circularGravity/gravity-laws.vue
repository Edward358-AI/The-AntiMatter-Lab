...
const page = storeToRefs(useUserStore()).GravityLaws
...
function runGrav() {
    ...
    var planet1 = Bodies.circle(200 / 800 * width, 400 / 800 * width, 30 / 800 * width, {
    ...
    var planet2 = Bodies.circle(600 / 800 * width, 200 / 800 * width, 35 / 800 * width, {
    ...
    Body.setVelocity(planet1, { x: 0, y: 4 / 800 * width })
    Body.setVelocity(planet2, { x: 0, y: -3 / 800 * width })
    ...
    if (planet3Active.value === true) {
        // Create new planet3
        planet3 = Bodies.circle(700 / 800 * width, 600 / 800 * width, 40 / 800 * width, {
            render: { fillStyle: '#c62fff' },
            restitution: 0.9,
            friction: 0,
            frictionAir: 0,
            mass: 12000 / 800 * width,
            sleepThreshold: Infinity
        });
...
<template>
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <div v-show="page === 0"><h4 class="text-center">Introduction</h4>
            ...
            <br><br>
            The Newton apple story is often cited as an instance of Newton "discovering" gravity, but this couldn't be
            further from the truth.
            Do you really think people didn't know that objects tended to fall down before then? No, Newton realized
            that the gravity
            that causes an apple to fall is the same that causes the moon remain in orbit around the Earth. Take a look
            at this demo. You can
            use your mouse to manipulate the "planets", but good luck catching them! Also, do NOT let the bodies clip
            into each other. They will disappear, and you
            will have to reset.
            <br><br>
            <figure>
                <h3 class="mb-4">Gravity Demo</h3>
                <button class="btn btn-outline-primary mb-3" @click='planet3Active = !planet3Active, runGrav()'> Toggle
                    Purple Planet</button><br>
            ...
            know gravity
            is always attractive, tending to pull bodies closer to each other. It also gets weaker with distance, though
            this might not be
            entirely obvious since you and I cannot easily go far away from the Earth. (Assuming you don't have access
            to a rocket.) These
            are quantitatively summed up by Newton.
            <br><br>
            From some data he borrowed from Robert Hooke (who later got into an argument with Newton over this exact
            issue of
            who deserved the recognition), Newton was able to formulate his Law of Universal Gravitation:
            <br><br>
            <b>$$F_g = G \dfrac{m_1m_2}{r^2}$$</b>
            <br><br>
            $G$ is a new constant, the universal gravitation constant, given by $G = 6.67 \times 10^{-11}$. This is a
            very small value, which
            explains why it takes something the size of a planet to produce a noticeable gravitational pull. The law is
            often called the inverse-square law because it depends inversely on the square of the separation between
            ...
            <br><br>
            <figure>
                <img src="/dynamics/Figure 40.png">
                <figcaption> Figure 1: Gravity is what keeps the moon in orbit around the Earth.</figcaption>
            </figure>
            <br><br>
            <span v-show="level > 0">
                <div class="problem">
                    I'm going to throw a conceptual question at you here. If the Earth exerts a force $F_g$ on a marble,
                    what force does the
                    marble exert on the Earth? Think carefully before you answer, since your intuition might not serve
                    you perfectly!
                    <br><br>
                ...
                theorem
                essentially states that the gravitational force from a spherical shell can be treated as coming from its
                center.
                ...
                <br><br>
                <div v-show="level == 2">
                    Thankfully, you are calculus students. I'll only prove the first part of the theorem since the
                    second is
                    exceedingly complex, and I'll simplify it even further by only considering an object of mass $m$
                    ...
                    with thickness $dy$.
                    <figure>
                        <img src="/dynamics/Figure 41.png">
                    ...
                    $x = R \cos \phi$ and $y = R \sin \phi$. Since this is a spherical shell, a thin ring along the
                    surface
                ...
                of the shell theorem to a solid sphere as well, which proves to be quite useful in problems involving
                many
                planets or stars that have large radii. Remember to measure the separation $R$ between the
                <b>centers</b> of the spheres and
                ...
                square of the distance, inside the planet things are different. We will go over this in the next
                section.
            </span>
            <span v-show="level == 0">
                Remember Newton's third law? Well, it still applies here! The Earth exerts a force on you, and you exert
                that
                ...
                that
                this theorem allows us to treat a sphere or spherical shell as having all of its mass at its center, and
                the distance between
                that center and any other object in question is the separation of the bodies $R$ in the equation.
                <br><br>
                The one key exception (and the second part of the shell theorem) to this is that there is <b>no
                    gravitational field</b> inside
                a spherical shell. This makes a sort of sense if you think about it, as the parts of the sphere you're
                closer to exert a stronger pull
                but are lesser in area, while the parts further away are more numerous but exert a lesser pull in the
        ...
        <div v-show="page === 1">
            ...
            <br><br>
            <figure>
                <img src="/dynamics/Figure 43.png">
                <figcaption> Figure 3: A not-so-fortunate soul gets to experience what it's like inside a planet.
                </figcaption>
            </figure>
            <br><br>
            <span v-show="level > 0">
                Now, what we want to realize is that any part of the planet above you can be considered a series of
                spherical shells.
                However, if they're above you, that means you are inside the shells and therefore they exert no
                ...
                The only part of the planet that matters, then, is the mass contained within a radius $r < R$, where $R$
                    ...
                    <figure>
                        ...
                        <figcaption> Figure 4: The effective mass acting when considering gravity at a distance $r$ from
                            the center of a planet.</figcaption>
                    </figure>
                    <br><br>
                    Now, to simplify things we'll assume the planet has a uniform density $\rho$. This isn't always
                    true; in fact, planets tend to get denser
                    towards their cores since there is a great pressure from gravity as you go deeper into the planet.
                    Dealing with non-uniform density is
                    ...
                    must be the same. Indeed,
                    when we plug $r=R$ into the expression we get the expected result. Here's a graph of the
                    gravitational field as a function
                    of $r$ from the center of the solid sphere:
                    <br><br>
                    <figure>
                        <img src="/dynamics/Figure 44.png">
                        <figcaption> Figure 5: The graph of $g$ vs. $r$ for a uniform solid sphere.</figcaption>
                    </figure>
                    <br><br>
                    Talking about just one object is boring, so next we're going to ramp it up to two objects. That is,
                    we're going to talk about
                    orbits.
            </span>
            <span v-show="level == 0">
                Gravity inside a planet (which is really just a solid sphere in this case) requires quite a few
                calculations, so we're just going
                to conceptually go over the subject without getting into the calculations. First, we have to realize
                that the sphere is really
                just a bunch of spherical shells nested inside each other. This means that inside the planet, you have
                two different parts of the planet
                that are acting on you. The part "above" you is a bunch of shells that you're inside, so it has no
                contribution to the field. Only the part "below" you
                can contribute to the gravitational field you experience. Here's a diagram to show what I mean by
                "above" and "below".
                <br><br>
                <figure>
                    <img src="/dynamics/Figure 42.png">
                ...
                <br><br>
                Now, the mass inside the black sphere is obviously not the entire mass of the planet. We are going to do
                approximate analysis of this problem
                by ignoring factors and writing everything as a proportionality such that the math is easier. If we
                assume the planet has constant
                density everywhere, this means that the mass $m$ enclosed is proportional to the density times volume,
                which is proportional to the cube of the
        ...
        <div v-show="page === 2"><h4 class="text-center">Orbits</h4>
            ...
            <br><br>
            For our first case, we'll consider a small object like a satellite in a circular orbit around a much larger
            body such as the Earth. This
            allows us to essentially ignore the effects of the satellite on the planet because of how much more massive
            the planet is.
            <br><br>
            <span v-show="level > 0">
                Now, we're going to assume that the satellite has a mass $m$, the planet a mass $M$, and the orbital
                radius is $R$. This should allow
                us to write force equations relatively simply. The only force acting on the satellite is the
                ...
                radius, there is only
                a single possible velocity! Indeed, this makes sense if you think about it. Orbiting near the Earth
                means you would have to
                move faster, and orbiting further away means you don't need to move as fast.
                <br><br>
                The result we derived above is simple, but it is a bit oversimplified in that it only considers the
                motion of the satellite. If the
                satellite were instead a planet with comparable mass to the Earth, we would have to consider the motion
                of both bodies. The easiest case
                to deal with is a binary system, with two identically massed objects orbiting each other.
                <br><br>
                <figure>
                    <img src="/dynamics/Figure 45.png">
                ...
                same mass, making our calculations much easier. Denoting the mass of each planet as $m$ and their total
                separation
                as $R$, we can write:
                <br><br>
                ...
                is not. Moreover, it's
                important to be careful in reading the question, as they may give you the orbital radius instead of the
                separation of the bodies.
                <br><br>
                This generalized problem is known as the two-body problem, and was solved completely by Newton. However,
                when Newton attempted
                to generalize this to three bodies in what is called the three-body problem (also a book, but that's
                something entirely
                unrelated), he found that he was unable to solve it. He chalked this up to insufficient mathematical
                prowess, but now we know that
                it is actually unsovable in most cases and requires direct computation by computers to actually solve.
                Why am I telling you this? Well, for
                one I think it's interesting. But also, I want to emphasize that this two-body scenario is as complex as
                most problems will get, though
                there are numerous variations on the scenario.
                <br><br>
                <figure>
                    <img src="/dynamics/threebody.gif">
            ...
            <span v-show="level == 0">
                There is math behind this, but we won't be too concerned with it here. Instead, we will reason through
                the
                results with qualitative analysis. First, we know that gravity gets weaker as the inverse of the square
                of
                separation $1/R^2$. Since the orbit is circular and gravity is the only force on the satellite, it must
                ...
                changed,
                but this is not the case for planetary orbits. This result is used in practice by geostationary
                satellites, which orbit
                at just the right altitude such that their orbital time is equal to 24 hours.
                <br><br>
                Now, what if the masses of the two objects were more similar? Well, this is what we call a binary
                system, and it exists
                in nature. Sometimes, two stars will become attracted by gravity and orbit each other in what is called
                a binary star
                ...
                is on either side of a diameter of the circle that describes their orbit. In other words, they are
                always 180° away from
                each other. This is also always true in all scenarios. But why did I make both masses identical? Well,
                it simplifies things.
                <br><br>
                Since both masses are identical, the situation can be significantly simplified. We have the center of
                mass exactly halfway
                between the two bodies, and each one's orbital radius is equal to exactly half of the separation between
                them as a result.
                They will also both orbit at the same speed. None of these are true generally, but rather arise because
                of the symmetry of this
                situation. If the two masses were different, more analysis would have to be done to determine details.
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/circularGravity/kepler">Next
                    Lesson!
                    &rarr;</NuxtLink>
            </div>
        </div>
    ...
    <div v-show="!lessonShowing" class="container h100 pt-5">
        <h1>Universal Gravitation Problems</h1><br>
