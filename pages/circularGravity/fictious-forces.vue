...
<template>
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <div v-show="page === 0"><h4 class="text-center">Introduction</h4>
            ...
            <span v-show="level > 0">
                ...
                <div class="problem">
                    ...
                    <figure>
                        <img src="/dynamics/Figure 37.png">
        ...
        <div v-show="page === 1">
            ...
            <br><br>
            <figure>
                <img src="/dynamics/EVIL FILE DO NOT OPEN.png" style="max-width:300px">
            ...
            <br><br>
            <figure>
                <img src="/dynamics/Figure 38.png">
        ...
        <div v-show="page === 2">
            <span v-show="level > 0">
                <div class="problem">
                    ...
                    <br><br>
                    <figure>
                        <img src="/dynamics/Figure 39.png">
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/circularGravity/gravity-laws">Next
                    Lesson!
                    &rarr;</NuxtLink>
            </div>
        </div>
