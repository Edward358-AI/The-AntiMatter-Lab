...
useHead({
    ...
    meta: [
        { name: 'description', content: 'Explore the properties of fluids, including key concepts and how it helps in understanding fluid behavior.' }
    ]
})
...
const page = storeToRefs(useUserStore()).FluidIntro
...
<template>
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <div v-show="page===1"><h4 class="text-center">Density</h4>
            ...
            <br><br>
            <figure>
                <img src="/fluids/Figure 104.png" style="max-width:700px"/>
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/fluids/pressure">Next Lesson!
                    &rarr;</NuxtLink>
            </div>
        </div>
        </p>
