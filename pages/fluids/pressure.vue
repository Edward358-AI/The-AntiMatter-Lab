...
useHead({
    title: 'Pressure',
    meta: [
        { name: 'description', content: 'Explore the concept of pressure in fluids, including its definition and applications in real-world scenarios.' }
    ]
})
...
const page = storeToRefs(useUserStore()).Pressure
...
<template>
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <div v-show="page===4">
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/fluids/fluid-flow">Next Lesson!
                    &rarr;</NuxtLink>
            </div>
        </div>
        </p>
