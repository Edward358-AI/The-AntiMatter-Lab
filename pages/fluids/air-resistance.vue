...
useHead({
    ...
    meta: [
        { name: 'description', content: 'Explore the concept of air resistance, including its principles and how to account for it in calculations.' }
    ]
})
