...
useHead({
    title: 'Fluid Flow',
    meta: [
        { name: 'description', content: 'Explore the concept of fluid flow, including its characteristics and different types.' }
    ]
})
...
const page = storeToRefs(useUserStore()).FluidFlow
...
<template>
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <p>
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/fluids/bernoulli">Next Lesson!
                    &rarr;</NuxtLink>
            </div>
            </div>
        </p>
