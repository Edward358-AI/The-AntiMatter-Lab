...
useHead({
    title: 'Spring Forces',
    meta: [
        { name: 'description', content: 'Explore the forces involved in spring dynamics and Hooke\'s law in physics.' }
    ]
})
    ...
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <div v-show="page === 0"><h4 class="text-center">Introduction</h4>
            ...
            <span v-show="level > 0">
                ...
                <br><br>
                <figure>
                    <img src="/dynamics/spring1.png" style="max-width:750px" />
        ...
        <div v-show="page === 1">
            <div class="problem">
                <span v-show="level > 0">
                    ...
                    <br><br>
                    <figure>
                        <img src="/dynamics/springincline.png" style="max-width:750px" />
        ...
        <div v-show="page === 2">
            ...
            <br><br>
            <figure>
                <img src="/dynamics/springseriesparallel.png" style="max-width:750px" />
            ...
            <span v-show="level > 0">
                ...
                <div class="problem">
                    ...
                    <br><br>
                    <figure>
                        <img src="/dynamics/springcut.png" />
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/circularGravity/centripetal">Next
                    Unit!
                    &rarr;</NuxtLink>
            </div>
        </div>
