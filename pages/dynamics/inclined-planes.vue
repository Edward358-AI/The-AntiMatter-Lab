<script setup>
useHead({
    title: 'Inclined Planes and Pulleys',
    meta: [
        { name: 'description', content: 'Explore the physics of inclined planes and pulleys and their applications in physics.' }
    ]
})
    ...
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <div v-show="page === 0"><h4 class="text-center">Introduction</h4>
            ...
            <p>
                ...
                <span v-show="level > 0">
                    ...
                    <br><br>
                    <figure>
                        <img src="/dynamics/Figure 18.png" />
                    ...
                    <br><br>
                    <figure>
                        <img src="/dynamics/Figure 19.png" />
                    ...
                    <br><br>
                    <figure>
                        <img src="/dynamics/Figure 20.png" />
                    ...
                    <br><br>
                    <figure>
                        <img src="/dynamics/Figure 21.png" />
        ...
        <div v-show="page === 1">
            ...
            <p>
                <span v-show="level > 0">
                    ...
                    <br><br>
                    <figure>
                        <img src="/dynamics/Figure 22.png" />
                    ...
                    <div v-show="level == 2">
                        ...
                        <div class="problem">
                            ...
                            <br><br>
                            <figure>
                                <img src="/dynamics/Figure 23.png" />
                            ...
                            <br><br>
                            <figure>
                                <img src="/dynamics/Figure 24.png" />
        ...
        <div v-show="page === 3">
            <p>
                ...
                <br><br>
            <figure>
                <img src="/dynamics/Figure 25.png" />
            ...
            <br><br>
            <figure>
                <img src="/dynamics/Figure 26.png" />
            ...
            <br><br>
            <figure>
                <img src="/dynamics/Figure 27.png" />
        ...
        <div v-show="page === 4">
            ...
            <p>
                ...
                <br><br>
            <figure>
                <img src="/dynamics/Figure 28.png" />
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/dynamics/spring">Next
