...
useHead({
    ...
    meta: [
        { name: 'description', content: 'Explore the principles of pendulum motion, including its definition, mathematical description, and real-world applications.' }
    ]
})
...
const page = storeToRefs(useUserStore()).Pendulum
    ...
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <p>
            <div v-show="page===0">
                ...
                <br><br>
                <figure>
                    <img src="/oscillations/Figure 98.png"/>
            ...
            <div v-show="page===1">
                ...
                <span v-show="level>0">
                    ...
                    <div class="problem">
                        ...
                        <br><br>
                        <figure>
                            <img src="/oscillations/Figure 99.png"/>
            ...
            <div v-show="page===3">
                ...
                <br><br>
                <figure>
                    <img src="/oscillations/Figure 100.png"/>
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/oscillations/other-oscillations">Next Lesson!
                     &rarr;</NuxtLink>
            </div>
            </div>
        </p>
