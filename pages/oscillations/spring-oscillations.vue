...
useHead({
    ...
    meta: [
        { name: 'description', content: 'Explore the physics of spring oscillations, and how it uses preexisting concepts from spring forces and simple harmonic motion.' }
    ]
})
...
const page = storeToRefs(useUserStore()).SpringOsc
    ...
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <div v-show="page === 1">
            ...
            <div class="btn-contain-left">
                <button class="btn btn-dark" style="animation: scale1 2s infinite;" @click="page--">
                    &larr; Previous
                </button>
            </div>
            <div class="btn-contain-right">
        ...
        <div v-show="page === 3">
            ...
            <br><br>
            <figure>
                <img src="/oscillations/Figure 97.png" style="max-width:750px" />
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/oscillations/pendulum">Next
                    Lesson!
                    &rarr;</NuxtLink>
            </div>
        </div>
