<script setup>
useHead({
    title: 'Other Oscillations',
    meta: [
        { name: 'description', content: 'Explore various types of oscillations that extend our understanding of simple harmonic motion, like the torsional pendulum and tuning fork.' }
    ]
})
    ...
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <p>
            <div v-show="page===0">
                ...
                <br><br>
                <figure>
                    <img src="/oscillations/Figure 101.png"/>
            ...
            <div v-show="page===1">
                ...
                <br><br>
                <figure>
                    <img src="/oscillations/Figure 102.png"/>
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/fluids/fluidintro">Next Unit!
                    &rarr;</NuxtLink>
            </div>
            </div>
        </p>
