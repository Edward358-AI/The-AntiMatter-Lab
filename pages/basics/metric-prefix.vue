...
useHead({
    ...
    meta: [
        { name: 'description', content: 'Learn about the various metric prefixes used in the International System of Units (SI).' }
    ]
})
...
const page = storeToRefs(useUserStore()).metricPrefix
...
<template>
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <div v-show="page === 1">
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/basics/trig">Next
                    Lesson!
                    &rarr;</NuxtLink>
            </div>
        </div>
