...
useHead({
    title: 'Trigonometry',
    meta: [
        { name: 'description', content: 'Learn about the fundamentals of trigonometry, including sine, cosine, and tangent functions.' }
    ]
})
...
const page = storeToRefs(useUserStore()).Trig
    ...
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <div v-show="page === 0">
            ...
            <p>
                ...
                <figure>
                    <img src="/basics/right_triangle.png">
                    <figcaption>
        ...
        <div v-show="page === 1">
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/basics/references">Next
                    Lesson!
                    &rarr;</NuxtLink>
            </div>
        </div>
