...
useHead({
    title: 'Basic Algebra',
    meta: [
        { name: 'description', content: 'Explore the fundamentals of algebra, including variables, equations, and their respective operations.' }
    ]
})
...
<template>
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <div v-show="page === 2">
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/basics/metric-prefix">Next
