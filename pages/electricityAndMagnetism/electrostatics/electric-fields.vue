...
useHead({
    ...
    meta: [
        { name: 'description', content: 'Learn about electric fields, field lines, and how they describe the force experienced by charged particles.' }
    ]
})
...
const page = storeToRefs(useUserStore()).ElectricFields
...
<template>
    ...
    <div v-show="!lessonShowing" class="container h100 pt-5">
        <h1>Electric Fields Problems</h1><br>
