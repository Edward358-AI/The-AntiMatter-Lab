...
<template>
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <div v-show="page===2">
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/electricityAndMagnetism/electrostatics/electric-fields">Next Unit! &rarr;</NuxtLink>
            </div>
        </div>
        </p>
    </div>
