...
useHead({
    ...
    meta: [
        { name: 'description', content: 'Explore the principles of two-dimensional motion, most notably projectile motion.' }
    ]
})
...
<template>
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <div v-show="page === 0">
            <p>
                ...
                <span v-show="level == 0">
                    ...
                    <br><br>
                    <figure>
                        <img src="/kinematics/Figure 12.png" />
        ...
        <div v-show="page === 1">
            <p>
                ...
                <span v-show="level > 0">
                    ...
                    <div class="problem">
                        ...
                        <br><br>
                        <figure>
                            <img src="/kinematics/Figure 13.png" style="max-width:200px;" />
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/kinematics/relative-velocity">Next
