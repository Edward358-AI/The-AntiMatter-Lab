...
useHead({
    ...
    meta: [
        { name: 'description', content: 'Explore the principles of one-dimensional motion, involving position, velocity, and acceleration, as well as introducing concepts like free-fall.' }
    ]
})
...
<template>
    <div v-show="lessonShowing" class="container h100 p-5">
                ...
                <span v-show="level > 0">
                    <div class="problem">The first problem will test you how well
                        ...
                        <div style="display: flex; justify-content: center; margin: 20px 0;">
                            <video controls oncontextmenu="return false" style="max-width: 750px; width: 100%; height: auto;">
        ...
        <div v-show="page === 2">
            <p>
                <span v-show="level == 0">
                    ...
                    <figure>
                        <img src="/kinematics/Figure 9.png" style="max-width:250px" />
            ...
            <p>
                ...
                <span v-show="level > 0">
                    ...
                    <div class="problem">Try and solve this problem yourself before looking at the
                        ...
                        <figure>
                            <img src="/kinematics/Figure 10.png" style="max-width:250px" />
        ...
        <div v-show="page === 5">
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/kinematics/two-d-motion">Next
