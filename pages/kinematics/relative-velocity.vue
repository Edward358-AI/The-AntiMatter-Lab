...
useHead({
    ...
    meta: [
        { name: 'description', content: 'Explore the concept of relative velocity, including its definition and how it relates to a new concept of reference frames.' }
    ]
})
...
const page = storeToRefs(useUserStore()).RelativeVel
    ...
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <div v-show="page === 1">
            ...
            <div class="problem">
                ...
                <br><br>
                <figure>
                    <img src="/kinematics/Figure 14.png" />
            ...
            <div class="btn-contain-right">
                <NuxtLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/dynamics/newton-laws">Next
                    Unit!!
                    &rarr;</NuxtLink>
            </div>
        </div>
