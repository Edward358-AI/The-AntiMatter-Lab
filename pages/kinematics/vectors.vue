...
useHead({
    title: 'Vectors',
    meta: [
        { name: 'description', content: 'Explore the concept of vectors, including their representation, operations, and applications in physics.' }
    ]
})
    ...
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <div v-show="page === 0"><h4 class="text-center">Introduction</h4>
            ...
            <h4 class="text-center">The Vector</h4>The first thing we
                ...
                <br><br>
            <figure>
                <img src="/kinematics/Figure 1.png" />
        ...
        <div v-show="page === 1">
            ...
            <h4 class="text-center">Vector Addition</h4>
                    ...
                    <br><br>
                    <figure>
                        <img src="/kinematics/Figure 11.png" />
            ...
            <h4 class="text-center">Graphical Methods</h4>
                ...
                <br><br>
            <figure>
                <img src="/kinematics/Figure 2.png" />
            ...
            <span v-show="level > 0">In the parallelogram method, both vectors are placed at the origin, and a
                ...
                <br><br>
                <figure>
                    <img src="/kinematics/Figure 3.png" />
        ...
        <div v-show="page === 2">
            ...
            <h4 class="text-center">Component Form</h4>Vectors can be defined via something called
                    ...
                    <br><br>
                    <figure>
                        <img src="/kinematics/Figure 6.png" />
            ...
            <h4 class="text-center">Algebraic Methods</h4>
                    ...
                    <br><br>
                    <figure>
                        <img src="/kinematics/Figure 4.png" />
            ...
            <h4 class="text-center">Component Form</h4>
                    ...
                    <br><br>
                    <figure>
                        <img src="/kinematics/Figure 5.png" />
            ...
            <div class="btn-contain-right">
                <RouterLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/kinematics/dimensional-analysis">Next
