...
<template>
  ...
  <Vectors v-if="user.current === lessons.kinematics[0]" :level="user.difficulty" :page="user.page.Vectors"
  ...
  <DimenAnalyz v-if="user.current === lessons.kinematics[1]" :level="user.difficulty" :page="user.page.DimenAnalyz"
  ...
  <PosVelAcc v-if="user.current === lessons.kinematics[2]" :level="user.difficulty" :page="user.page.PosVelAcc"
  ...
  <OneDMotion v-if="user.current === lessons.kinematics[3]" :level="user.difficulty" :page="user.page.OneDMotion"
  ...
  <TwoDMotion v-if="user.current === lessons.kinematics[4]" :level="user.difficulty" :page="user.page.TwoDMotion"
  ...
  <RelativeVel v-if="user.current === lessons.kinematics[5]" :level="user.difficulty" :page="user.page.RelativeVel"
  ...
  <Newton v-if="user.current === lessons.dynamics[0]" :level="user.difficulty" :page="user.page.Newton"
  ...
  <OtherForces v-if="user.current === lessons.dynamics[1]" :level="user.difficulty" :page="user.page.OtherForces"
  ...
  <FmaFBD v-if="user.current === lessons.dynamics[2]" :level="user.difficulty" :page="user.page.FmaFBD"
  ...
  <InclinedPlanes v-if="user.current === lessons.dynamics[3]" :level="user.difficulty"
  ...
  <Spring v-if="user.current === lessons.dynamics[4]" :level="user.difficulty" :page="user.page.Spring"
  ...
  <Fictious v-if="user.current === lessons.circularGravity[1]" :level="user.difficulty" :page="user.page.Fictious"
  ...
  <Kepler v-if="user.current === lessons.circularGravity[3]" :level="user.difficulty" :page="user.page.Kepler"
  ...
  <DotProd v-if="user.current === lessons.energy[0]" :level="user.difficulty" :page="user.page.DotProd"
  ...
  <Work v-if="user.current === lessons.energy[1]" :level="user.difficulty" :page="user.page.Work"
  ...
  <Energy v-if="user.current === lessons.energy[2]" :level="user.difficulty" :page="user.page.Energy"
  ...
  <EqTypes v-if="user.current === lessons.energy[3]" :level="user.difficulty" :page="user.page.EqTypes"
  ...
  <Power v-if="user.current === lessons.energy[4]" :level="user.difficulty" :page="user.page.Power"
  ...
  <GravEnergy v-if="user.current === lessons.energy[5]" :level="user.difficulty" :page="user.page.GravEnergy"
  ...
  <Impulse v-if="user.current === lessons.momentum[0]" :level="user.difficulty" :page="user.page.Impulse"
  ...
  <LinMomConsrv v-if="user.current === lessons.momentum[1]" :level="user.difficulty" :page="user.page.LinMomConsrv"
  ...
  <CenterOfMass v-if="user.current === lessons.momentum[2]" :level="user.difficulty" :page="user.page.CenterOfMass"
  ...
  <Collisions v-if="user.current === lessons.momentum[3]" :level="user.difficulty" :page="user.page.Collisions"
  ...
  <Explosions v-if="user.current === lessons.momentum[4]" :level="user.difficulty" :page="user.page.Explosions"
  ...
  <Torque v-if="user.current === lessons.rotation[1]" :level="user.difficulty" :page="user.page.Torque"
  ...
  <MomentInertia v-if="user.current === lessons.rotation[2]" :level="user.difficulty" :page="user.page.MomentInertia"
  ...
  <Rolling v-if="user.current === lessons.rotation[4]" :level="user.difficulty" :page="user.page.Rolling"
  ...
  <AngMomentum v-if="user.current === lessons.rotation[5]" :level="user.difficulty" :page="user.page.AngMomentum"
  ...
  <SHM v-if="user.current === lessons.oscillations[0]" :level="user.difficulty" :page="user.page.SHM"
  ...
  <SpringOsc v-if="user.current === lessons.oscillations[1]" :level="user.difficulty" :page="user.page.SpringOsc"
  ...
  <Pendulum v-if="user.current === lessons.oscillations[2]" :level="user.difficulty" :page="user.page.Pendulum"
  ...
  <OtherOsc v-if="user.current === lessons.oscillations[3]" :level="user.difficulty" :page="user.page.OtherOsc"
  ...
  <FluidIntro v-if="user.current === lessons.fluids[0]" :level="user.difficulty" :page="user.page.FluidIntro"
  ...
  <Pressure v-if="user.current === lessons.fluids[1]" :level="user.difficulty" :page="user.page.Pressure"
  ...
  <FluidFlow v-if="user.current === lessons.fluids[2]" :level="user.difficulty" :page="user.page.FluidFlow"
  ...
  <AirResistance v-if="user.current === lessons.fluids[3]" :level="user.difficulty" :page="user.page.AirResistance"
  ...
  <Bernoulli v-if="user.current === lessons.fluids[4]" :level="user.difficulty" :page="user.page.Bernoulli"
