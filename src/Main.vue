...
<template>
  ...
  <div class="sidebar offcanvas offcanvas-start" id="mobile-menu">
    ...
    <div class="offcanvas-header border-bottom border-secondary border-opacity-25 justify-content-center p-0">
      <div @click="lessonShowing=true; hideMobileBar();Window.scrollTo(0,0)" :class="lessonShowing ? 'sidebarTab col border-end border-secondary border-opacity-25 p-2 bg-secondary-subtle' : 'sidebarTab col border-end border-secondary border-opacity-25 p-2'">Lessons</div>
      <div @click="lessonShowing=false;  hideMobileBar();Window.scrollTo(0,0)" :class="lessonShowing ? 'sidebarTab col p-2' : 'sidebarTab col p-2 bg-secondary-subtle'">Problems</div>
    </div>
    <div class="offcanvas-header border-bottom border-secondary border-opacity-25">
  ...
  <div class="sidebar offcanvas-start offcanvas-md" id="menu"
    ...
    <div class="offcanvas-header border-bottom border-secondary border-opacity-25 justify-content-center p-0">
      <div @click="lessonShowing=true;Window.scrollTo(0,0)" :class="lessonShowing ? 'sidebarTab col border-end border-secondary border-opacity-25 p-2 bg-secondary-subtle' : 'sidebarTab col border-end border-secondary border-opacity-25 p-2'">Lessons</div>
      <div @click="lessonShowing=false;Window.scrollTo(0,0)" :class="lessonShowing ? 'sidebarTab col p-2' : 'sidebarTab col p-2 bg-secondary-subtle'">Problems</div>
    </div>
    <div class="offcanvas-header border-bottom border-secondary border-opacity-25">
      <input v-model="searchQuery" type="text" class="form-control" placeholder="Type here to find a lesson...">
    </div>
  ...
  <Vectors v-if="user.current === lessons.kinematics[0]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.Vectors"
  ...
  <DimenAnalyz v-if="user.current === lessons.kinematics[1]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.DimenAnalyz"
  ...
  <PosVelAcc v-if="user.current === lessons.kinematics[2]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.PosVelAcc"
  ...
  <OneDMotion v-if="user.current === lessons.kinematics[3]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.OneDMotion"
  ...
  <TwoDMotion v-if="user.current === lessons.kinematics[4]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.TwoDMotion"
  ...
  <RelativeVel v-if="user.current === lessons.kinematics[5]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.RelativeVel"
  ...
  <Newton v-if="user.current === lessons.dynamics[0]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.Newton"
  ...
  <OtherForces v-if="user.current === lessons.dynamics[1]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.OtherForces"
  ...
  <FmaFBD v-if="user.current === lessons.dynamics[2]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.FmaFBD"
  ...
  <Spring v-if="user.current === lessons.dynamics[4]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.Spring"
  ...
  <Centripetal v-if="user.current === lessons.circularGravity[0]" :level="user.difficulty" :lessonShowing="lessonShowing" 
  ...
  <Fictious v-if="user.current === lessons.circularGravity[1]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.Fictious"
  ...
  <GravityLaws v-if="user.current === lessons.circularGravity[2]" :level="user.difficulty" :lessonShowing="lessonShowing" 
  ...
  <Kepler v-if="user.current === lessons.circularGravity[3]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.Kepler"
  ...
  <DotProd v-if="user.current === lessons.energy[0]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.DotProd"
  ...
  <Work v-if="user.current === lessons.energy[1]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.Work"
  ...
  <Energy v-if="user.current === lessons.energy[2]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.Energy"
  ...
  <EqTypes v-if="user.current === lessons.energy[3]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.EqTypes"
  ...
  <Power v-if="user.current === lessons.energy[4]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.Power"
  ...
  <GravEnergy v-if="user.current === lessons.energy[5]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.GravEnergy"
  ...
  <Impulse v-if="user.current === lessons.momentum[0]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.Impulse"
  ...
  <LinMomConsrv v-if="user.current === lessons.momentum[1]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.LinMomConsrv"
  ...
  <CenterOfMass v-if="user.current === lessons.momentum[2]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.CenterOfMass"
  ...
  <Collisions v-if="user.current === lessons.momentum[3]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.Collisions"
  ...
  <Explosions v-if="user.current === lessons.momentum[4]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.Explosions"
  ...
  <RotationalKinematics v-if="user.current === lessons.rotation[0]" :level="user.difficulty" :lessonShowing="lessonShowing" 
  ...
  <Torque v-if="user.current === lessons.rotation[1]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.Torque"
  ...
  <MomentInertia v-if="user.current === lessons.rotation[2]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.MomentInertia"
  ...
  <RotationalDynamics v-if="user.current === lessons.rotation[3]" :level="user.difficulty" :lessonShowing="lessonShowing" 
  ...
  <Rolling v-if="user.current === lessons.rotation[4]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.Rolling"
  ...
  <AngMomentum v-if="user.current === lessons.rotation[5]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.AngMomentum"
  ...
  <SHM v-if="user.current === lessons.oscillations[0]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.SHM"
  ...
  <SpringOsc v-if="user.current === lessons.oscillations[1]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.SpringOsc"
  ...
  <Pendulum v-if="user.current === lessons.oscillations[2]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.Pendulum"
  ...
  <OtherOsc v-if="user.current === lessons.oscillations[3]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.OtherOsc"
  ...
  <FluidIntro v-if="user.current === lessons.fluids[0]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.FluidIntro"
  ...
  <Pressure v-if="user.current === lessons.fluids[1]" :level="user.difficulty" :lessonShowing="lessonShowing"  :page="user.page.Pressure"
