...
<template>
  ...
  <Bernoulli v-show="user.current === lessons.fluids[3]" :level="user.difficulty" :page="user.page.Bernoulli"
  ...
  <AirResistance v-show="user.current === lessons.fluids[4]" :level="user.difficulty" :page="user.page.AirResistance"
