        ...
        <p>
            <div v-show="page===0">
                ...
                <figure>
                    ...
                    <label>Blue ball mass: {{ mass1 }}</label>&ensp;<input type="range" v-model="mass1" min="1" max="100" step="0.1" style="outline: 2px solid #0078d7; border-radius: 8px;
            background: #e0e0e0"/> &emsp; &emsp;
                    <label>Red ball mass: {{ mass2 }}</label> &ensp;<input type="range" v-model="mass2" min="1" max="100" step="0.1" style="outline: 2px solid #0078d7; border-radius: 8px;
            background: #e0e0e0"/>
                <br>
                <label>Blue ball speed: {{ vel1 }}</label>&ensp;<input type="range" v-model="vel1" min="-10" max="10" step="0.1" style="outline: 2px solid #0078d7; border-radius: 8px;
            background: #e0e0e0"/> &emsp; &emsp;
                    <label>Red ball speed: {{ vel2 }}</label> &ensp;<input type="range" v-model="vel2" min="-10" max="10" step="0.1" style="outline: 2px solid #0078d7; border-radius: 8px;
            background: #e0e0e0"/><br>
            <label>Elasticity (bounciness): {{ elasticity }}</label> &ensp;<input type="range" v-model="elasticity" min="0" max="1" step="0.01" style="outline: 2px solid #0078d7; border-radius: 8px;
            background: #e0e0e0"/><br>
                </figure>
            <br>
