    ...
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <div v-show="page === 0">
            <p>
                ...
                <br><br>
                This lesson is designed to help you review basic algebra concepts that are necessary for understanding physics. Again, for you algebra-based and calculus-based kids, this should already be a breeze and you can comfortably skip this lesson. However, if you are new to algebra or need a refresher, this lesson will cover the basics of algebraic operations, equations, and functions that will be occasionally used throughout the course, even in the conceptual difficulty. 
            </p>
