    ...
    <div v-show="lessonShowing" class="container h100 p-5">
        ...
        <p>
            <div v-show="page===0">
                ...
                <br><br>
                <figure>
                <img src="/src/assets/oscillations/Superior Sine Wave.png" style='max-width:750px'>
                <figcaption>
            ...
            <div v-show="page===2">
                ...
                <br><br>
                <figure>
                <img src="/src/assets/oscillations/Figure 96.png" style='max-width: 750px'>
                <figcaption>
            ...
            <div class="btn-contain-right">
                <RouterLink class="btn btn-dark" style="animation: scale 2s infinite;" @click="page=0" to="/spring-oscillations">Next Lesson!
                    &rarr;</RouterLink>
            </div>
            </div>
        </p>
