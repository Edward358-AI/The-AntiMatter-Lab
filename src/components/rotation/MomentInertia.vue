        ...
        <p>
            <div v-show="page===0">
                ...
                <span v-show="level>0">
                    ...
                    $$ I = \sum m_i {r_i}^2 $$
                    <br>
                    This definition is a bit clunky and difficult to understand, so I'll break it down. Essentially, you look at each point on the object and 
                    note how far it is from the center of rotation. Then, you add up each individual point object. Yes, the actual process inherently 
                    ...
                    asked. This shape is the simplest possible in terms of moment of inertia, and for all others calculus is required to derive 
                ...
                <span v-show="level==0">
                    The formula for the moment of inertia of a very small point object is very simple. It considers the mass $m$ of the object and 
                    the distance of the object from the axis of rotation $r$.
                    <br><br>
                    $$ I = mr^2$$
                    <br>
                    This definition is deceptively simple. While yes, it is very accurate, it only accounts for points. To find the moment of 
                    inertia of rigid bodies like disks, spheres, or cylinders, we need to sum over every single point in an object to find the 
                    total moment of inertia. This is no small feat and requires calculus, so for the most part we'll skip over this.
                    <br><br>
                    There is one notable example that can be done with clever reasoning, without having to invoke any complex math.
                    <br><br>
                    <div class="problem">
                        What is the moment of inertia of a very thin hoop (mass $m$, radius $r$) about an axis through its center of mass and perpendicular to it? You 
                        ...
                        <br><br>
                        The entire rim is located a constant distance $r$ from the center, which allows us to conclude that each point has the same moment of 
                        inertia. Moreover, the entire mass $m$ of the object is at a distance $r$ from the axis of rotation, letting us write:
                        <br><br>
                        $$\bbox[3px,
                        border: 0.5px solid
                        white]{I = mr^2} $$
                        <br>
                        The rotating ring is equivalent to a rotating point mass! We typically don't think of them as rotating the same way, but that's because while gravity 
                        effectively acts at the axis of rotation for a ring (which causes no torque), while it acts at the point mass's location in that case (which usually does cause a torque, because 
            ...
            <div v-show="page===1">
                ...
                <br><br>
                <span v-show="level>0">
                    We have seen the definition of moment of inertia as being proportional to mass and radius squared. This is 
                    true in general, and for all objects the general form is followed, just with some numerical factor added in front. In our 
                    analysis, we will ignore the effect of mass on the moment of inertia since we know that adding mass increases it and vice 
                    versa. Thus, we can write:
                    <br><br>
                    $$ I \propto r^2 $$
                    <br>
                    Recall that this definition really is applied to each point mass, not just the entire object. Therefore, we see that moment of inertia 
                    is greater when more parts of the object are at a greater radius from the axis of rotation. This is what I meant when I said 
                    moment of inertia is affected by how mass is distributed within an object. Objects with more mass distributed closer to the edges of the 
                    material will tend to have a greater moment of inertia than similar objects that have a more uniform distribution.
                    <br><br>
                    As a simple example, the moment of inertia of a 
                    solid, thin disk is less than that of a hoop with the same mass and radius because the disk has more of its mass distributed closer to 
                    the center of rotation, while the hoop has all of it at the maximum distance $r$ from the axis.
                    <br><br>
                    Another somewhat unrelated idea is that liquids tend to contribute very little, which we approximate as nothing, to the moment of inertia
                    when rotating about their center of mass. If you spin a can full of juice around its center, the can moves but the liquid inside tends to stay 
                    level, which is evidence that it isn't really rotating. However, liquids can still contribute a nontrivial amount of moment of inertia under 
                    some situations.
                </span>
                <span v-show="level==0">
                    We have seen that the formula for the moment of inertia is directly related to the distance of each point mass within 
                    a rigid object. This means that if more mass is concentrated around the outer edges of the material, the moment of inertia will 
                    be greater because more of the mass is located further away from the axis of rotation.
                    <br><br>
                    Even if the actual radius of the object isn't changed, the moment of inertia will increase depending on how mass is distributed. This is why 
                    a hoop has a greater moment of inertia than a solid disk of the same mass and radius, because the hoop has all of its mass distributed 
                    at its edges while the disk has it uniformly distributed, with some being closer to the axis of rotation.
                </span>
                <br><br>
                Now that we have an understanding of the factors outside of total mass that affect moment of inertia, I will propose a practice 
                problem in order to test your understanding of this topic. These questions are purely conceptual and do not require significat calculations to solve.
                <br><br>
                <div class="problem">
                ...
                <span>
                    <div v-show="show" class = 'answer' style="width:fit-content">
                        <strong>Answer:</strong> The thin pipe, because it has more of its mass distributed at a greater distance from the center.
                        <br>
                    </div>
                ...
                <span>
                    <div v-show="show1" class = 'answer' style="width:fit-content">
                        <strong>Answer:</strong> Spinning about its end produces a greater moment of inertia because the maximum distance from the axis of rotation 
                        becomes the entire length of the rod. If it was about its center, then the max distance would only be half of the length.
                        <br>
                    </div>
                ...
                <span>
                    <div v-show="show2" class = 'answer' style="width:fit-content">
                        <strong>Answer:</strong> The moment of inertia is doubled, since it directly depends on mass and the <b>square</b> of the radius.
                        <br>
                    </div>
                ...
                <span>
                    <div v-show="show3" class = 'answer' style="width:fit-content">
                        <strong>Answer:</strong> It decreases, because the distance of the fly from the center is steadily decreasing.
                        <br>
                    </div>
            ...
            <div v-show="page===2">
                ...
                should be common knowledge. Thankfully, these expressions are not awfully complex and can be pretty easily memorized 
                with practice. The shapes in question are also relatively simple ones, like cylinders, rods, and spheres. For the later chapters, 
                I <b>will not</b> provide the moments of inertia of these objects.
                <br><br>
                Let's start by diagramming the different shapes we're going to be dealing with, as well as the axes of rotation 
                that we care about.
                <br><br>
                <figure>
                ...
                <span v-show="level>0">
                    ...
                    $$ I = MR^2 $$
                    <br>
                    This actually applies to a long, hollow cylinder as well. That's because the moment of inertia formula accounts for distance 
                    from the axis of rotation, and the axis is a long line. Thus, for a cylinder the cross-sectional shape would be the same, and the 
                    moment of inertia would also be the same. The distance from the axis to the walls of the cylinder is the same as for a hoop.
                    <br><br>
                    The second shape is the solid disk. It has been talked about briefly before, but we haven't talked about its actual moment of inertia.
                    <span v-show="level==2">The calculus for this one is simple, so we'll do it as an example. The mass is $M$, and the radius is $R$.
                        <br><br>
                        Consider integrating outwards from the center in thin rings of thickness $dr$. Each ring has some mass that can be found due to the 
                        fact that the disk is uniform. By using the rules of density, we find that the mass $dm$ of each individual ring can be 
                        written as: 
                        <br><br>
                    ...
                    The moment of inertia of a solid disk is less than that of a thin hoop, as expected. In fact, it is exactly half of 
                    that for a hoop of the same radius and mass:
                    <br><br>
                    $$ I = \dfrac12 MR^2 $$
                    <br>
                    Like the thin ring and hollow cylinder, the thin disk and the solid cylinder share the formula above for the same reason. I find 
                    that the hollow cylinder is a little less common, but the solid cylinder is a very commonly used shape. It's also a shape you'll see 
                    often in the real world.
                    <br><br>
                    Our next shape is the thin rod rotated about its center. For this one, we usually use $L$ to denote the entire length 
                    of the rod. <span v-show="level==2">It's possible to derive the formula for this one as well relatively simply, but I'll 
                        leave this for you to do on your own if you're interested.
                    </span>
                    <br><br>
                    $$ I = \dfrac{1}{12} ML^2 $$
                    <br>
                    This result technically only works for an infinitely thin (one-dimensional, to be precise) rod, but when an object is thin enough we usually use this 
                    as a good enough approximation.
                    <br><br>
                    Next is the same rod, rotated about one of its ends. As you would expect, the moment of inertia is much greater for this 
                    case. It's what we explained in the question back on the previous page, after all!
                    <br><br>
                    $$ I = \dfrac13 ML^2 $$
                    <br>
                    The next two shapes see us returning to circular-ish objects. However, spheres and circles are only similar, not identical! First, we have the solid sphere of radius $R$ rotated about a diameter. 
                    The moment of inertia of this shape is equal to:
                    <br><br>
                    $$ I = \dfrac{2}{5} MR^2 $$
                    <br>
                    This is the smallest factor in front of $MR^2$ that you'll see in this list, and it's because a solid sphere has a lot of its mass 
                    concentrated closer to the center than the other shapes on this list.
                    <br><br>
                    Next is our spherical shell of radius $R$. It might look superficially similar to the solid sphere, but it is completely hollow, only 
                    being a very thin shell. Its moment of inertia is larger than that of the solid sphere as you would expect, and equal to:
                    <br><br>
                    $$ I = \dfrac{2}{3} MR^2 $$
                    <br>
                ...
                <span v-show="level==0">
                    ...
                    $$ I = MR^2 $$
                    <br>
                    The second shape is the solid disk. It has been talked about briefly before, but we haven't talked about its actual moment of inertia. It's 
                    ...
                    $$ I = \dfrac{1}{12} ML^2 $$
                    <br>
                    Next, the same rod is rotated about its end. You should recall that we said the moment of inertia should be larger.
                    <br><br>
                    $$ I = \dfrac13 ML^2 $$
                    <br>
                    ...
                    $$ I = \dfrac{2}{5} MR^2 $$
                    <br>
                    This is the smallest multiplier in front of $MR^2$ that you'll see in this list, and it's because a solid sphere has a lot of its mass 
                    concentrated closer to the center than the other shapes on this list.
                    <br><br>
                ...
                That's all of the shapes that you need to know the moments of inertia for! Here's a concise chart with each shape and its 
