...
<template>
    <div class="container-fluid p-5 m-auto mw-1120">
        ...
        <p>This project was created originally in the summer of 2024 as a passion project to give the world a better
            ...
            a better understanding of yourself and the world around you.</p><br><br>
        ...
        <p>If you just opened up this website or you're simply stuck on where to start, we recommend starting from the
            ...
            <span><strong>Conceptual:</strong> Simple as possible, avoiding using complex mathematical calculations/representations when possible. Basic arithmetic, however, is required.</span><br>
            ...
            <span><strong>Calculus-Based:</strong> The purest form of physics, which expands on algebra-based physics with calculus concepts. Concurrent learning or previously taken AP® Calculus AB (or of similar material) is required.</span><br><br>
