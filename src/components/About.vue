...
<template>
    <div class="container p-5">
        ...
        <p>This project was created originally in the summer of 2024 as a passion project to give the world a better
            ...
            physics club). Physics is not an easy concept to grasp, and this project was aimed to target those areas
            ...
            a better understanding of yourself and the world around you.<br>This project is currently tending to lack in practice problems, you can find practice problems in this textbook, which also provides pretty good examples and demonstrations as well: <a class="link-underline-secondary" href="https://drive.google.com/file/d/1hftVOFnduES1T_PrRzfTNhLNYu3OUSPc/view?usp=sharing" target="_blank">link here</a></p><br><br>

        <h1>Need Help?</h1><br>
        <p>If you just opened up this website or you're simply stuck on where to start, we recommend starting from the
            first lesson, unless you have something specific that you are looking for. Then you can use our handy search
            bar to find the exact lesson you want. The key difference between this and other physics tutorials out there
        ...
        <p>This project was built using HTML, CSS and JS.<br>The use of VueJS (<a class="link-underline-secondary" href="https://vuejs.org"
                target="_blank">https://vuejs.org</a>) was incorporated to allow dynamic rendering and much easier
            implementation of certain functionalities over regular JS.<br>A CSS framework, Halfmoon CSS (<a class="link-underline-secondary"
                href="https://www.gethalfmoon.com" target="_blank">https://www.gethalfmoon.com</a>), was also used to
            effortlessly create a (somewhat) nice looking layout and website.<br>MathJax (<a class="link-underline-secondary" href="https://mathjax.org" target="_blank">https://mathjax.org</a>) and Vue-MathJax-Next (<a class="link-underline-secondary" href="https://github.com/justforuse/vue-mathjax-next" target="_blank">https://github.com/justforuse/vue-mathjax-next</a>) were implemented for clean looking equations and math symbols.<br>Vite (<a class="link-underline-secondary" href="https://vitejs.dev"
        ...
        <p>If you have any questions, about physics or not, you can contact Edward via discord (edward.jiang_) or email
            (<a class="link-underline-secondary" href="mailto:edward456jiang@gmail.com" target="_blank">edward456jiang@gmail.com</a>). If the question is
            physics related, you are most likely much better off asking Eric (discord: antimatter162, email: <a class="link-underline-secondary"
                href="mailto:antimatter5175@gmail.com" target="_blank">antimatter5175@gmail.com</a>).</p><br><br>

        <h1>License</h1><br>
        <p>This project is licensed under the MIT License.</p><br><br>
    </div>
</template>
