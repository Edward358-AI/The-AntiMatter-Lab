        ...
        <div v-show="page === 1">
            <p>
                <span v-show="level == 0">
                    ...
                    trajectory (assuming no air resistance), the same rule applies: the object thrown at some velocity $v$
                    ...
                    for calculating the grand scheme of things, so you might as well. You might be thinking that modeling
                ...
                <span v-show="level > 0">
                    ...
                    steps, although some are omitted for the sake of simplicity (and so that it doesn't take up the entire screen).
                    <br><br>
                    ...
                    <div class="problem">
                        ...
                        The algebra in between is omitted for the sake of clarity. It is up to you to do the math. Challenge 
                        ...
                        one possible answer if the ball is actually to go through the hoop. Eric was nice enough to give you a hint, the
                        ...
                        The ball will pass through the same height twice during its motion (think of what a parabola looks like) but it won't 
                        go through the hoop if it's moving upwards, which is what the smaller solution represents. Enough rambling. Now if we plug in the values,
                        we get:
                        <br><br>
                    ...
                    <div class="problem">
                        ...
                        <br><br>If it was thrown straight upwards, the max height equation reduces to $H_2=\frac{v_0^2}{2g}$
