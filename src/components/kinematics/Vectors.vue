...
const questions = reactive(
    [
        ...
        [ // algebra difficutly
            ...
            {
                number: 2,
                question: "<img style='max-width: 170px;' src='../../assets/kinematics/Problem1.png' class='rounded'><br>What is the component form of a vector with magnitude $7$ and argument (angle) of $60 \\degree$ with respect positive x-axis?",
                answers: [
            ...
            {
                number: 3,
                question: "<img style='max-width: 170px;' src='../../assets/kinematics/Problem2.png' class='rounded'><br>What is the magnitude of the resultant vector of adding the 2 blue vectors as depicted?",
                answers: [
                    ["$8.2~\\textrm{m}$", 1, false],
                    ["$8.0~\\textrm{m}$", 0, false],
                    ["$7.8~\\textrm{m}$", 0, false],
            ...
            {
                number: 5,
                question: "<img style='max-width: 200px;' src='../../assets/kinematics/Problem3.png' class='rounded'><br>Find the magnitude of the resultant vector of adding these three vectors together.",
                answers: [
                    ["$8.1~\\textrm{N}$", 0, false],
                    ["$7.9~\\textrm{N}$", 0, false],
                    ["$7.5~\\textrm{N}$", 0, false],
