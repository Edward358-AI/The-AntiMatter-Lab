...
const results = reactive([[0, 0,0,0,0], [0], [0]]) // update as add more questions
const explanations = reactive([[false, false,false,false,false], [false], [false]]) // keeps track of what explanations are visible
...
<template>
    ...
    <div v-show="!lessonShowing" class="container-fluid h100 pt-5">
        ...
        <form @submit.prevent="checkAnswer(q.number)" style="height:fit-content" class="question col-6 row justify-content-center my-5"
