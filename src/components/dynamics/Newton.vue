...
<template>
    <div class="container h100 p-5">
        ...
        <div v-show="page === 1">
            <p>
                Newton’s first law has to do with the idea of motion.<br><br>
            </p>
            ...
            small quirk that is not mentioned here. This only holds true when the <i>net</i>, total, or sum of all the
            ...
            something. This opposes the commonly perceived idea that force is directly responsible for causing motion,
            but rather, force changes motion. As seen in the ice example, a continuous force is not required to keep an
            ...
            reference frame is a reference frame, or coordinate system, that which objects obey Newton's First Law. That
            means the frame itself is not accelerating, because if it was, the objects would accelerate without external
            forces, and since acceleration is defined as change in velocity, its velocity, or motion, is changing, and
            that is a violation of Newton's First Law. Furthermore, Newton's First Law does not also hold true for a
            frame that is constantly changing orientation, the more common form being rotating. A change in direction
            means acceleration, since acceleration is <i>change</i> in motion (remember the example of going around in a
            circle from position, velocity, acceleration). Again, Newton's First Law is invalid for a rotating frame, or
        ...
        <div v-show="page === 2">
            ...
            <div class="problem" style="text-align:center;font-size:1.05rem;width:fit-content;margin:auto;">
                Newton’s Second Law (Law of Acceleration): The net force acting on an object is equal to its mass times
                its acceleration.
            </div>
            <p><br>
